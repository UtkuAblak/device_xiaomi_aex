...
# Charger Offline Xiaomi 8.5.1.0
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/charger/healthd_xiaomi:$(TARGET_ROOT_OUT)/root/sbin/healthd

# Symlink /charger to /sbin/healthd_xiaomi
LOCAL_POST_INSTALL_CMD := $(hide) mkdir -p $(TARGET_ROOT_OUT) \
    rm -f $(TARGET_ROOT_OUT)/root/charger && ln -sf $(TARGET_ROOT_OUT)/root/sbin/healthd $(TARGET_ROOT_OUT)/root/charger
